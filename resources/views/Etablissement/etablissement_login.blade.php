...
@section('content')
<form action="{{ route('etablissement_login_submit') }}" method="post" class="mt-4">
    @csrf
    ...
    <div class="mt-3">
        <span class="psw float-end forgot-password "> <a href="{{ route('etablissement_forget_password') }}"> Forgot password?</a></span>
